...
module DbcValidationTests =
    ...
    """
        ...
        | Failure errors -> errors |> should equal [ "Duplicate message ID 100 found." ]
    ...
    """
        ...
        | Failure errors ->
            errors
            |> should equal [ "Signal 'Signal_2' in message 'MESSAGE_1' overlaps with other signals." ]
    ...
    """
        ...
        | Failure errors ->
            errors
            |> should equal [ "Signal 'Signal_1' in message 'MESSAGE_1' exceeds the message DLC of 2 bytes." ]
    ...
    """
        ...
        | Failure errors ->
            errors
            |> should equal [ "Multiple multiplexer switch signals found in message 'MUX_BAD'." ]
    ...
    """
        ...
        | Failure errors ->
            errors
            |> should equal [ "Multiplexed signal 'Branch' in message 'MUX_MISSING' is missing a switch value (m<k>)." ]
